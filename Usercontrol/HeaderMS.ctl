...
'*******************************************************'
'* Description:   This usercontrol a simple frame con- *'
'*                trol but not exactly as Intrinsic VB *'
'*                frame control or another.            *'
'*-----------------------------------------------------*'
'* CREDITS AND THANKS                                  *'
'*-----------------------------------------------------*'
'*                Carles P.V., for the gradient, bit-  *'
'*                map tiling, and corner rounding rou- *'
'*                tines                                *'
'*.....................................................*'
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
   With PropBag
     BackColor1 = .ReadProperty("BackColor1", ConvertSystemColor(defBackColor1))
     BackColor2 = .ReadProperty("BackColor2", ConvertSystemColor(defBackColor2))
     BackColor3 = .ReadProperty("BackColor3", ConvertSystemColor(defBackColor3))
     BackColor4 = .ReadProperty("BackColor4", ConvertSystemColor(defBackColor4))
     BorderColor = .ReadProperty("BorderColor", ConvertSystemColor(defBorderColor))
     m_lCaption = .ReadProperty("Caption", Ambient.DisplayName)
     Enabled = .ReadProperty("Enabled", True)
     Set g_Font = .ReadProperty("Font", Ambient.Font)
     ...
     Call SetAccessKeys
     ShadowColor = .ReadProperty("ShadowColor", ConvertSystemColor(defShadowColor))
   End With
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
   With PropBag
     Call .WriteProperty("BackColor1", m_lBackColor1, ConvertSystemColor(defBackColor1))
     Call .WriteProperty("BackColor2", m_lBackColor2, ConvertSystemColor(defBackColor2))
     Call .WriteProperty("BackColor3", m_lBackColor3, ConvertSystemColor(defBackColor3))
     Call .WriteProperty("BackColor4", m_lBackColor4, ConvertSystemColor(defBackColor4))
     Call .WriteProperty("BorderColor", m_lBorderColor, ConvertSystemColor(defBorderColor))
     Call .WriteProperty("Caption", m_lCaption, Ambient.DisplayName)
     Call .WriteProperty("Enabled", m_lEnabled, True)
     Call .WriteProperty("Font", g_Font, Ambient.Font)
     Call .WriteProperty("ForeColor", m_lForeColor, &H80000012)
     Call .WriteProperty("MousePointer", MousePointer, vbDefault)
     Call .WriteProperty("MouseIcon", MouseIcon, Nothing)
     Call .WriteProperty("ShadowColor", m_lShadowColor, ConvertSystemColor(defShadowColor))
   End With
End Sub
